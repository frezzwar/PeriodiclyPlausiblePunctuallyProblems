...
public final class AOption2Actionthink extends PActionthink
{
    ...
    public Object clone()
    {
        return new AOption2Actionthink(
    ...
    {
        ((Analysis) sw).caseAOption2Actionthink(this);
    }
