...
public final class ALessEqualCompareToken extends PCompareToken
{
    private TLessEqual _lessEqual_;

    public ALessEqualCompareToken()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALessEqualCompareToken(
    ...
    {
        ((Analysis) sw).caseALessEqualCompareToken(this);
    }
