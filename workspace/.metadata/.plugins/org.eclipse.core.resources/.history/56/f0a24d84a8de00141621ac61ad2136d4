...
public final class ALessEqualBoolOperator extends PBoolOperator
{
    private TLessEqual _lessEqual_;

    public ALessEqualBoolOperator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALessEqualBoolOperator(
    ...
    {
        ((Analysis) sw).caseALessEqualBoolOperator(this);
    }
