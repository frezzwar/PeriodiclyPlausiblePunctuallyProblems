...
public final class AIfstructureControlstructure extends PControlstructure
{
    private TIf _if_;
    ...
    public AIfstructureControlstructure()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIfstructureControlstructure(
            cloneNode(this._if_),
    ...
    {
        ((Analysis) sw).caseAIfstructureControlstructure(this);
    }
