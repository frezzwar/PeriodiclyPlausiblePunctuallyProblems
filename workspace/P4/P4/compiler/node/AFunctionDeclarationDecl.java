...
public final class AFunctionDeclarationDecl extends PDecl
{
    private PFunctionDeclaration _functionDeclaration_;

    public AFunctionDeclarationDecl()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFunctionDeclarationDecl(
    ...
    {
        ((Analysis) sw).caseAFunctionDeclarationDecl(this);
    }
