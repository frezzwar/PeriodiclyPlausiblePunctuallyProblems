...
public final class AGreaterEqualCompareToken extends PCompareToken
{
    private TGreaterEqual _greaterEqual_;

    public AGreaterEqualCompareToken()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGreaterEqualCompareToken(
    ...
    {
        ((Analysis) sw).caseAGreaterEqualCompareToken(this);
    }
