...
public final class AGreaterCompareToken extends PCompareToken
{
    private TGreater _greater_;

    public AGreaterCompareToken()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGreaterCompareToken(
    ...
    {
        ((Analysis) sw).caseAGreaterCompareToken(this);
    }
