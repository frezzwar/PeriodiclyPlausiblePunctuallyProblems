...
public final class AGreaterEqualOpcompare extends POpcompare
{
    private POpcompare _opcompare_;
    private TGreaterEqual _greaterEqual_;
    private PValue _value_;

    public AGreaterEqualOpcompare()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGreaterEqualOpcompare(
    ...
    {
        ((Analysis) sw).caseAGreaterEqualOpcompare(this);
    }
