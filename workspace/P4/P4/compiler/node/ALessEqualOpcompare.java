...
public final class ALessEqualOpcompare extends POpcompare
{
    private POpcompare _opcompare_;
    private TLessEqual _lessEqual_;
    private PValue _value_;

    public ALessEqualOpcompare()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALessEqualOpcompare(
    ...
    {
        ((Analysis) sw).caseALessEqualOpcompare(this);
    }
